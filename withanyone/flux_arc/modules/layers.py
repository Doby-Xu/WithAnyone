...
class DoubleStreamBlockProcessor:
    def __call__(self, attn, img, txt, vec, pe, mask, text_length, image_length, return_map, **attention_kwargs):
        ...
        # print("Shape of scale and shift tensors are:")
        # print("img_mod1.scale:", img_mod1.scale.shape)
        # print("img_mod1.shift:", img_mod1.shift.shape)
        # print("txt_mod1.scale:", txt_mod1.scale.shape)
        # print("txt_mod1.shift:", txt_mod1.shift.shape)
        # 1 token they are [B, 1, D]
